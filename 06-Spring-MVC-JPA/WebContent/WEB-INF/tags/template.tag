    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<c:url value="/disciplina/cadastrar"/>">Cadastrar</a>
          <a class="dropdown-item" href="<c:url value="/disciplina/listar"/>">Listar</a>        
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<c:url value="/prova/cadastrar"/>">Cadastrar</a>
          <a class="dropdown-item" href="<c:url value="/prova/listar"/>">Listar</a>        
        </div>
      </li>
      <li class="nav-item">
